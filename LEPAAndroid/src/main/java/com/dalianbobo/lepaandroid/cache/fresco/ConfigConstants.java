package com.dalianbobo.lepaandroid.cache.fresco;
...
/**
 * facebook图片加载框架  缓存配置
 * Created by Clown Fish on 2016/1/14.
 */
public class ConfigConstants {
    ...
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "lepa_cache";//小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = "def_cache";//默认图所放路径的文件夹名
...
//                .setOldController(view.getController())//DraweeController复用
    ...
    public static void init(final Resources resources) {
        ...
        if (sPlaceholderDrawable == null) {
            sPlaceholderDrawable = resources.getDrawable(R.mipmap.p_ico);
        }
